...
export default function Hero() {
    return (
        <section className="min-h-[80vh] flex items-center justify-center px-4 sm:px-6 lg:px-36 relative overflow-hidden pt-16 lg:pt-12">
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center lg:-mt-16">
                {/* Left Content */}
                <div className="space-y-6 lg:space-y-8 text-center lg:text-left">
                    <div className="space-y-4">
                        <h1 className="text-4xl lg:text-6xl xl:text-7xl leading-tight">
                            ...
                            <br />
                            <span className="name-gradient font-bold">
                                Misael Lima
                            </span>
                        </h1>
